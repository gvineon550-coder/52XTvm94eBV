...
UNSTABLE_FILE = "romaxa55_unstable.m3u"
REPORT_FILE = "romaxa55_report.txt"
STATS_FILE = "romaxa55_stats.json"
...
def main():
    ...
    russia_all = [ch for ch in all_channels if get_group(ch["extinf"]) in TARGET_GROUPS]
    print("Russia group: " + str(len(russia_all)))

    after_quality = []
    dropped_quality = 0
    for ch in russia_all:
    ...
    report.append("- Russia group: " + str(len(russia_all)))
